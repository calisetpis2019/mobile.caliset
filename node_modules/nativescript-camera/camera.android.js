    ...
    return new Promise(function (resolve, reject) {
        try {
            ...
            if (options) {
                ...
                console.log(options.nameOfPicture);
            }
            ...
            if (saveToGallery_1) {
                picturePath_1 = android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_DCIM).getAbsolutePath() + "/Camera/" + options.nameOfPicture + "_" + dateStamp + ".jpg";
